...
$sh_proData = json_decode(file_get_contents("php://input"), true);
...
// 檢查是否有收到值
if(isset($_POST['sh_pro_state'])) {
    $sh_pro_state = $_POST['sh_pro_state']; // 假設接收到的是 0 或 1
    // SQL 更新
    $sql = "UPDATE sh_pro 
    SET sh_pro_state = :sh_pro_state,
